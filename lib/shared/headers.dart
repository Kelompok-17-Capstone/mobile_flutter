...
Widget homeHeader(BuildContext context) {
  ...
  final int notificationCount = Provider.of<NotificationProvider>(context)
      .notifications
  ...
  Future<void> searchProduct(
      ...
      required SearchDelegate<void> delegate}) async {
    if (globalCooldown) {
      return;
    }
    ...
    await Future.delayed(const Duration(seconds: 2), () async {
      await showSearch(
          query: searchController.text, context: context, delegate: delegate);
      if (context.mounted) {
                ...
                GestureDetector(
                  onTap: () {
                    if (user == null) {
                      showDialog(
                        context: context,
                        builder: (context) => popupMessageDialog(context,
                            judul: 'Maaf',
                            content:
                  ...
                  child: Stack(
                    children: [
                      Transform.translate(
                        ...
                        child: const Image(
                          image:
                              AssetImage('assets/images/products/monitor.png'),
                        ),
                      ),
                      Transform.translate(
                      ...
                      Transform.translate(
                        ...
                        child: const Image(
                          image:
                              AssetImage('assets/images/products/headset.png'),
                        ),
                      ),
                    ],
                  ),
  ...
  return SizedBox(
    ...
    child: Stack(
      ...
      children: [
        ...
        Positioned(top: 0, child: content),
        Padding(
