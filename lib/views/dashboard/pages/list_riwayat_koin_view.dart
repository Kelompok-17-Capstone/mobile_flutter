...
class _ListRiwayatKoinState extends State<ListRiwayatKoin> {
  ...
  Widget build(BuildContext context) {
    final List<CoinModel> history =
        Provider.of<CoinProvider>(context, listen: false).history;
            ...
            children: [
              ...
              Padding(
                ...
                child: history.isEmpty
                    ? const Center(
                        child: Text('Saat ini tidak ada riwayat koin'))
                              ...
                              return ListTile(
                                ...
                                leading: Image(
                                    image: const AssetImage(
                                        'assets/icons/CurrencyCircleDollar.png'),
