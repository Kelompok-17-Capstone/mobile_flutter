...
class _DetailProductViewState extends State<DetailProductView> {
                      ...
                      children: [
                        Container(
                          ...
                          child: Hero(
                            tag: product.id,
                            child: cachedImage(
                                url: product.imgUrl, fit: BoxFit.fitWidth),
                            // child: Image(
                            //   fit: BoxFit.fitWidth,
                            ...
                            child: Row(
                              children: [
                                IconButton(
                                  onPressed: () async {
                                    if (user == null) {
                                      ...
                                      if (result == 'success') {
                                        if (!mounted) return;
                                        snackBar(context,
                                            'Berhasil menambahkan produk ke favorit');
                                      } else {
                                        if (!mounted) return;
                                  ...
                                  icon: Image.asset(
                                      'assets/icons/HeartStraight.png'),
                                  color: const Color(0xFF264ECA),
                                ),
              ...
              leftContent: IconButton(
                onPressed: () {
                  showBuyNowDialog(context,
                      label: 'Tambahkan Keranjang', product: product);
                },
  ...
  Future<void> showBuyNowDialog(BuildContext context,
                          ...
                          if (guestMode) {
                            ...
                            if (isDirectCheckout) {
                              ...
                              Navigator.pushNamed(context, '/checkout',
                                  arguments: CheckoutViewArgument(cart: [
                                    ItemCartModel(
                                        cartId: null,
                                        productId: product.id,
