...
class _CheckoutViewState extends State<CheckoutView> {
  ...
  int countTotalPayment(
      {required int totalProduct, required int shippingCost}) {
    int coin = isCoinEnabled
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar:
          customAppBar(context, title: 'Rincian Pesanan', isBackButton: true),
      body: Column(
        children: [
          Expanded(
              ...
              child: Padding(
                ...
                child: Column(
                  children: [
                    ListTile(
                      leading: Image(
                          image: const AssetImage('assets/icons/MapPin.png'),
                    ...
                    ListView.builder(
                      ...
                      itemBuilder: (context, index) {
                        ...
                        return ListTile(
                          isThreeLine: true,
                          leading: Image(
                              image: NetworkImage(item.imgUrl), height: 60),
                          title: Text(
                            item.productName,
                            style: const TextStyle(
                    ...
                    ListTile(
                      dense: true,
                      leading: Image(
                          image: const AssetImage('assets/icons/Ticket.png'),
                          color: CustomColors.primary),
                    ...
                    ListTile(
                      dense: true,
                      leading: Image(
                          image: const AssetImage('assets/icons/Coins.png'),
                          color: CustomColors.primary),
                      title: Text(
                          'Tukarkan ${user.coin >= totalProduct() ? formatRupiah(totalProduct()) : formatRupiah(user.coin)} koin',
                    ...
                    ListTile(
                      ...
                      title: Row(
                        children: [
                          Image(
                              image: const AssetImage(
                                  'assets/icons/ClipboardText.png'),
                              color: CustomColors.primary),
                        ...
                        child: Column(
                          children: [
                            ...
                            Row(
                              ...
                              children: const [
                                Text(
                                    'Subtotal biaya pengiriman (gratis ongkir)'),
                                Text('Rp0')
                              ],
                            ),
                            const SizedBox(height: 5),
                            ...
                            Row(
                              ...
                              children: [
                                ...
                                Text(
                                    formatRupiah((totalProduct() * 0.3).ceil()))
                              ],
                            ),
                            Row(
                              mainAxisAlignment: MainAxisAlignment.spaceBetween,
          ...
          buyNowButton(
              ...
              child: TextButton(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      formatRupiah(countTotalPayment(
                          totalProduct: totalProduct(), shippingCost: 0)),
                      style: const TextStyle(color: Color(0xFF264ECA)),
                    )
                  ],
                ),
              ),
            ...
            onPressed: () async {
              if (countTotalPayment(
                      totalProduct: totalProduct(), shippingCost: 0) >
                  user.balance + user.coin) {
                showDialog(
                  context: context,
                  builder: (context) {
                    return popupMessageDialog(context,
                        judul: 'Gagal',
                        content:
                            'Saldo tidak cukup, silahkan lakukan top-up saldo Anda');
                  },
                );
              } else {
                final String result =
                  ...
                  await showDialog(
                    ...
                    builder: (context) {
                      return popupMessageDialog(context,
                          judul: 'Berhasil',
                          content:
                              'Pembayaran telah berhasil, silahkan cek pesanan Anda.');
                    },
                  );
                  if (!mounted) return;
                  Navigator.popUntil(
